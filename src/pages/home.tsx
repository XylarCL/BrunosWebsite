export default function Home() {
    return(
        <div className="heroSection">
            ...
            <img className="heroSection-img mobileImg" src="%PUBLIC_URL%\assets\imgs\Bruno\Bruno-Portrait_v01_.jpg" height="450px" width="450px"/>
            
            <a href="mailto:brudebattista@gmail.com" target="_blank" className="heroSection-CTAButton">CONTACT</a>

            <img className="heroSection-img desktopImg" src="%PUBLIC_URL%\assets\imgs\Bruno\Bruno-Portrait_v01_.jpg" height="450px" width="450px"/>
        </div>
    )
}
