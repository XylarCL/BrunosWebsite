...
export default function SideHeader() {
    ...
    return (
        <div className="sideHeader">
            ...
            <a className="sideHeader-content" href="\imgs\Bruno_Debattista_CV 2.pdf" target="_blank"><img className="sideHeader-img" src="\assets\imgs\sideHeaderIcons\CV.png" height="50px" width="50px"/></a>
